...
<section class="panel p-5">
    ...
    <div class="rounded-md border border-dashed border-stone-300 bg-stone-50 p-4 text-sm text-stone-700">
        <p class="font-medium">Implement the purchase order form UI in this file.</p>
        <ul class="mt-2 list-disc space-y-1 pl-5">
            <li>Create a <code>form</code> that POSTs to <code>/purchase-orders</code>.</li>
            <li>Add inputs named <code>poId</code> (hidden for edit), <code>poNumber</code>, <code>reqId</code>, <code>quoteId</code>, <code>supplierId</code>, <code>deptId</code>, <code>orderDate</code>, <code>deliveryDate</code>, <code>subtotal</code>, <code>taxAmount</code>, <code>totalAmount</code>, <code>status</code>, <code>notes</code>, and <code>createdBy</code>.</li>
            <li>Add a submit button for create/update and keep the field names exactly as listed.</li>
            <li>Add a separate delete form in the list page that POSTs to <code>/purchase-orders/delete</code> with <code>poId</code>.</li>
        </ul>
    </div>
</section>
